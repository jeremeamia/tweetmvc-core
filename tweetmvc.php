...
function c($k){static$c;$c=$c?:include'config'.EXT;return$c[$k];}error_reporting(c('er'));foreach(c('extensions')as$f)require c('x').$f.EXT;#Setup TweetMVC and load extensions
